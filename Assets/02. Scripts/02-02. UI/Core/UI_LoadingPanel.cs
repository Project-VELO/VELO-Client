...
///
/// 페이드로 드나들되 <b>입력 차단은 페이드와 무관하게 즉시</b> 시작하고, 페이드 아웃이 끝날 때까지
/// 유지합니다. 알파가 0이어도 blocksRaycasts가 켜져 있으면 클릭이 막히므로, 연출이 도는 동안에도
/// 떠나는 화면의 버튼은 눌리지 않습니다. 가려진 버튼이 눌리는 편이 0.2초 더 막히는 것보다 나쁩니다.
/// </summary>
