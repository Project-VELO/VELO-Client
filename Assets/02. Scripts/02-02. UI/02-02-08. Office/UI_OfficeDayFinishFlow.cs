...
///
/// 상태·저장 커밋(FinishDay)을 연출보다 먼저 수행합니다. 기획서 순서로는 연출(3단계)이
/// 상태 변경(4단계)보다 앞이지만, 16-7이 "연출 도중 게임이 종료되더라도 재실행 시 다음 날짜"를
/// 요구하므로 커밋을 뒤로 미루면 배너 도중 종료 시 하루가 되돌아갑니다.
/// 커밋을 앞당기고 화면 갱신 시점만 조절하면 보이는 순서는 기획서 그대로 유지됩니다.
/// </summary>
